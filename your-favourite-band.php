<?php
  ...
  $bandName = "Fantastic Band";
  $bandFoundationDate = date("Y/m/d");
  // Step 2 - Create the following PHP array: Band Members
  $bandMembers = array("Junyeong Yu", "John", "Sakura", "Domingo");
  $bandMembersCount = count($bandMembers);
?>
