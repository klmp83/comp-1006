    	...
    	<form method="post" action="add_artist.php">
    		<fieldset>
    			...
    			<div class="form-group">
	    			...
	    			<input type="text" name="name" class="form-control" placeholder="White Stripes" maxlength="50" required="required" />
	    		</div>
    			<div class="form-group">
	    			<label>Bio Link</label>
	    			<input type="url"  name="bio_link" class="form-control" placeholder="https://en.widipedia.org/wiki/The_White_Stripes" maxlength="100" />
	    		</div>
